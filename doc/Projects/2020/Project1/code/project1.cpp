...
double* general_algo(int,double,clock_t&,clock_t&); // general tridiagonal solver
double* specific_algo(int,double,clock_t&,clock_t&); // 2nd order DE solver
double* LU_algo(int,double,clock_t&,clock_t&); // LU decomp and solver from lib.h
...
int main(int argc, char *argv[]){
  ...
  else{// Display Time. Used for timing experiment. { } marks position of time value
...
double* general_algo(int n, double h, clock_t& start, clock_t& finish){
  // Creating arrays:
...
double* specific_algo(int n, double h,clock_t& start, clock_t& finish){
...
double* LU_algo(int n, double h, clock_t& start, clock_t& finish){
  // Creating arrays:
  double **A;
  double *g = new double[n];
  double *u = new double[n+2];
