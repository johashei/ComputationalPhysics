...
\usepackage{relsize,makeidx,color,setspace,amsmath,amsfonts,amssymb,physics,mathtools}
...
\begin{center}
{\bf \href{{http://www.uio.no/studier/emner/matnat/fys/FYS3150/index-eng.html}}{Computational Physics I FYS4150}}
\end{center}

    \begin{center}
% List of all institutions:
\centerline{{\small Johannes Sørby Heines}}
\end{center}
...
\bmqty{%\dmat[\cdots]{2 & -1 & 0\\-1 & 2 & -1\\0 & -1 & 2,\cdots,2 & -1 & 0\\-1 & 2 & -1\\0 & -1 & 2 }}
